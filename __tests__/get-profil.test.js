...
describe('Get Profile API', () => {
	// Connexion à la base de données avant exécution des tests
	beforeAll(async () => {
	...
	it('Should return profile of the authenticated user', async () => {
		// Effectué la connexion et récupéré le token
		...
		const userId = '65af8f6b90320202053c08af';
		...
		console.log('Utilisateur récupéré:', responseProfil.body.user);
	});
});
